...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_password_too_short(user_manager: UserManager, mock_user_create: UserCreate):
...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_password_no_uppercase(user_manager: UserManager, mock_user_create: UserCreate):
    with pytest.raises(InvalidPasswordException) as excinfo:
...
@pytest.mark.unit
@pytest.mark.asyncio
async def test_valid_password(user_manager: UserManager, mock_user_create: UserCreate):
    try:
