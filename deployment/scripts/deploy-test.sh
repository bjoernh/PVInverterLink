...
# Default to 'test' tag for test environment, or use environment variable
...
sleep 5
curl -f http://test.solar.64b.de/healthcheck || curl -f http://localhost:8080/healthcheck || echo -e "${RED}Health check failed!${NC}"
...
echo ""
echo "Services:"
echo "  - Backend: http://test.solar.64b.de"
echo "  - API Docs: http://test.solar.64b.de/docs"
echo "  - Admin: http://test.solar.64b.de/admin"
echo ""
