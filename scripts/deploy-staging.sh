...
sleep 5
curl -f http://staging.yourdomain.com/healthcheck || echo -e "${RED}Health check failed!${NC}"
...
echo ""
echo "Services:"
echo "  - Backend: http://staging.yourdomain.com"
echo "  - API Docs: http://staging.yourdomain.com/docs"
echo "  - Admin: http://staging.yourdomain.com/admin"
echo "  - SignOz: http://signoz.yourdomain.com/staging"
echo ""
